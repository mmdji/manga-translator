...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center p-4 font-[Vazirmatn] overflow-hidden">
      ...
      <div 
        className={`bg-slate-900/60 backdrop-blur-2xl p-6 md:p-8 rounded-[2.5rem] border-2 text-center w-full max-w-xl shadow-2xl transition-all duration-500 relative z-10 ${
      ...
      >
        <div 
          className="border-4 border-dashed border-slate-700/60 rounded-3xl p-8 md:p-12 cursor-pointer hover:bg-slate-800/40 transition-colors group relative overflow-hidden"
          ...
          <div className="flex flex-col items-center gap-6 z-10 relative">
            {file ? (
              <div className="animate-bounce-slow">
                 <MangaJiLogo size="text-3xl md:text-4xl" />
              </div>
            ) : (
              <Upload className="w-20 h-20 text-slate-600 group-hover:text-cyan-400 transition-all duration-300 group-hover:scale-110 group-hover:rotate-12" />
            )}
            
            <div className="space-y-2">
              <span className={`text-lg md:text-xl font-bold block transition-colors ${file ? 'text-cyan-300' : 'text-slate-200'}`}>
        ...
        <button 
          ...
          className={`w-full mt-6 py-5 rounded-2xl font-black text-xl flex justify-center items-center gap-3 transition-all duration-300 relative overflow-hidden text-white
            ${loading || !file 
      ...
      <footer className="mt-12 text-slate-500 text-sm font-medium z-10 relative">
